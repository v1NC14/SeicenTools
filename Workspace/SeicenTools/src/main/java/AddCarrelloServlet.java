    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(session.getAttribute("user") != null){
            try{
                ...
                //CarrelloService service = new CarrelloService() oppure tramite DAO
                //service.addoToCart(user, tmp)

                //String psAdd = "INSERT INTO carrelloutente (id_utente, id_prodotto) VALUES(?, ?)";"
